            ...
            <div className="container max-w-full">
                ...
                <div className="w-12/12 grid grid-cols-6 mt-10"> 
                    ...
                    < div className="flex flex-grid gap-4 lg:col-span-4 col-span-6 lg:p-5 md:p-5 sm:p-5 p-2 lg:m-0 md:m-0 sm:m-0 m-2 text-justify border-2 border-dashed border-amber-500 leading-8">
                        ...
                        <Paragraph text={<>I'm Hadi Mirzaie, called Mr. Rabbit, a programmer interested in blockchain. <br /> I write about Web3 and PHP, and sometimes I do the hardest thing of all: thinking. Animal lovers mostly loved Kitty ^__^ . <br /> My expertise is in php, laravel, JS, NextJS, and Tailwind.</>}/>
