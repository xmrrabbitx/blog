...
export default function CodeBlock(props:{title:string,code:any,description:string}){
    ...
    return(
        <div className="bg-zinc-900 rounded p-3 xl:text-base lg:text-base md:text-base text-xs mt-2">
            <div className="text-green-400">{props.title}</div>

            <div className="flex flex-row">
                <code className={`${styles.codeblock}  text-fuchsia-500 xl:text-xl lg:text-base md:text-base text-base whitespace-pre w-full basis 3/4`} >{props.code}</code>
