...
import HeaderPic from "@/public/pics/how-to-handle-errors-of-smart-contracts-on-web3js-handlRevert/smartContract.png"
...
export default function index(){
    ...
    return(
        ...
        <div>
            ...
            <Head>
                <title>How to handle errors of smart contracts on web3js: (handlRevert)</title>
            ...
            <div className="container max-w-full">
                <div className="lg:text-center md:text-center sm:text-center text-left pl-5 pr-5 mt-16 lg:text-3xl md:text-3xl sm:text-2xl text-xl font-bold">How to handle errors of smart contracts on web3js: (handlRevert)</div>
