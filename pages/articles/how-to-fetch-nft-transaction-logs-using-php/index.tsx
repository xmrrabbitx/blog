    ...
    return(
        ...
        <div>
            ...
            <div className="container max-w-full">
                <header className="lg:text-center md:text-center sm:text-center text-left pl-5 pr-5 mt-16 lg:text-3xl md:text-3xl sm:text-2xl text-xl font-bold">How to Fetch NFT Transaction Logs Using PHP</header>
