...
"data":{
    ...
    "date-6":"2023-10-19",
    "title-7":"pure-SQL-is-10x-faster-than-PHP:-use-SQL-queries-as-much-as-you-can",
    "description-7":"I was getting into comparing SQL with the PHP fetch assoc command and seeing how long it takes to reach a specific value in the MySQL database....",
    "date-7":"2023-11-02",
